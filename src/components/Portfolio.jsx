...
const Portfolio = () => {
  ...
  return <div name='portfolio' className='bg-gradient-to-b  from-black via-green-900 to-black w-full text-white md:h-screen'>
        ...
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
          ...
          {
           portfolio.map(({ _id, src, dlink, clink }) => (

              <div key={_id} className='shadow-lg shadow-gray-900 rounded-lg'>
